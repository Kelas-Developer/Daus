<?php
    ...
    <html lang="en">
    <head>
        <title>CRUD Produk dengan gambar - Firdaus</title>
        <style type="text/css">
            * {
    ...
    <body>
        ...
        <div>
            ...
            <input type="text" namae="deskripsi" value="<?php echo $data['deskripsi']; ?>" />
        </div>
        <div>
            <label for="">Harga Beli</label>
            <input type="text" name="harga_beli" required="value"<?php echo $data['harga_jual']; ?>" />
        </div> 
        <div>
